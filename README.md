# Android-Challenge-for-Fever

# The main goal of this test is to do it in 2 hours max.
...
You will have 2 hours to complete the task, and return the results via mail, zipped. There are no
limitations on what IDE to use.
